...
const (
	...
	Echo_ProxyEcho_FullMethodName = "/echo.Echo/ProxyEcho"
)
...
type EchoClient interface {
	...
	ProxyEcho(ctx context.Context, in *EchoReq, opts ...grpc.CallOption) (*EchoResp, error)
}
...
func (c *echoClient) ProxyEcho(ctx context.Context, in *EchoReq, opts ...grpc.CallOption) (*EchoResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EchoResp)
	err := c.cc.Invoke(ctx, Echo_ProxyEcho_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EchoServer interface {
	...
	ProxyEcho(context.Context, *EchoReq) (*EchoResp, error)
...
func (UnimplementedEchoServer) ProxyEcho(context.Context, *EchoReq) (*EchoResp, error) {
...
func _Echo_ProxyEcho_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EchoReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EchoServer).ProxyEcho(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Echo_ProxyEcho_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EchoServer).ProxyEcho(ctx, req.(*EchoReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Echo_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Echo_ProxyEcho_Handler,
		},
	},
